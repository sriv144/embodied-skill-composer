...
| 3 | Frozen 20-run manifest, exact five-checkpoint validation selection, held-out split gate, hierarchical aggregation, ablation decisions, durable matrix API/executor, and complete 240-episode synthetic protocol smoke are implemented. Local and remote gate evidence will be recorded before this phase is checked. See [research protocol](construction-intelligence-v1-protocol.md). |
